  ...
  return (
    <html lang="en">
      <body className={inter.className + " min-h-screen bg-background text-foreground"}>
        <PostHogProvider>
          {/* Top nav for desktop */}
          <nav className="hidden sm:flex sticky top-0 w-full justify-center py-3 px-2 bg-white/80 backdrop-blur-sm shadow-sm border-b border-slate-200 dark:border-slate-800 z-40">
