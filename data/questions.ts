...
export const questions: Question[] = [
    ...
    { id: 28, topic: "Medicine-Related", text: "Pros/cons of healthcare system?" },
    { id: 29, topic: "Medicine-Related", text: "What changes would you make?" },
    { id: 30, topic: "Medicine-Related", text: "Do doctors make too much money?" },
    { id: 31, topic: "Medicine-Related", text: "What is the Hippocratic Oath?" },
    { id: 32, topic: "Medicine-Related", text: "Medicare vs Medicaid?" },
